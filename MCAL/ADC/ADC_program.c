...
void ADC_VoidRead8Channel(u16 array[])
{
	ADC_SetSignleEndChannel(ADC0);
	ADC_voidStartConversion();
	array[0]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC1);
	ADC_voidStartConversion();
	array[1]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC2);
	ADC_voidStartConversion();
	array[2]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC3);
	ADC_voidStartConversion();
	array[3]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC4);
	ADC_voidStartConversion();
	array[4]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC5);
	ADC_voidStartConversion();
	array[5]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC6);
	ADC_voidStartConversion();
	array[6]= ADC_u16ReadADCInMV();
	
	ADC_SetSignleEndChannel(ADC7);
	ADC_voidStartConversion();
	array[7]= ADC_u16ReadADCInMV();
